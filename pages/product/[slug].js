    ...
    <section class="text-gray-600 body-font overflow-hidden">
      <div class="container px-5 py-14 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/61Dl8WUFr7L._AC_UL480_QL65_.jpg" />
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div class="flex">
              ...
              <button class="flex ml-6 md:ml-20 text-white bg-pink-500 border-0 py-2 px-4 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
              <button class="flex ml-2 md:ml-2 text-white bg-pink-500 border-0 py-2 px-4 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
