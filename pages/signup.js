          ...
          <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div className=" rounded-md shadow-sm">
              <div className=" mb-4">
                ...
                <input type="text" id="name" name="name" className="relative block w-full py-1.5 bg-white rounded border border-gray-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="Enter Your Name" />
              </div>
              <div className='my-10'>
              ...
              <div className='mt-10'>
                ...
                <input id="password" name="password" type="password" autocomplete="current-password" required className="relative block w-full  bg-white rounded border border-gray-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="Enter Your Password" />
              </div>
            </div>
