...
export default function Home() {
  return (
    <>
      <Head>
        <title>SnapShop e-Commerce Website</title>
        <meta name="description" content="Codeswear .comWear the codeswaer" />
      ...
      <div>
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="flex flex-wrap -m-4">
              <div className="xl:w-1/3 md:w-1/2 p-4">
                <div className="border border-gray-200 p-6 rounded-lg">
                  <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-gray-300 text-regal-blue mb-4">
            ...
            <button className="flex mx-auto mt-16 text-white bg-regal-blue border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg">Button</button>
          </div>
        </section>
      </div>
     
      {/* <div className='mx-80 text-blue-900 backdrop-brightness-50'> hello this is codesrear skdfj </div> */}
    </>
  )
}
