...
export default function TopMain() {
    return <section id="home" className={styles.home}>
        ...
        <div className='left-0 right-0 py-32   flex flex-col items-center sm:px-20  px-10 justify-center text-center'>
            <h1 className={`${styles.banner} absolute mt-14 `}>
                Welcome to <span className=''>CHOISEWEAR</span>
            </h1>
            <div className={`${styles.slogan} absolute mt-72 `} >
